...
DEVELOPMENTS_RAW = [
    # Premium high-end (Polanco / Lomas / Pedregal)
    {
        ...
        "memoria_acabados": [
            {"area": "Pisos", "detalle": "Mármol en áreas sociales, duela de ingeniería en recámaras"},
            {"area": "Cocina", "detalle": "Integral Poliform, cubierta de cuarzo, electrodomésticos Gaggenau"},
            {"area": "Baños", "detalle": "Mármol, grifería Hansgrohe, muebles suspendidos"},
            {"area": "Ventanería", "detalle": "Doble cristal piso a techo con control solar"},
            {"area": "Clima", "detalle": "Aire acondicionado central por zonas"},
            {"area": "Domótica", "detalle": "Luces, clima y accesos desde el celular"},
        ],
    ...
    # ─── Phase B3 Chunk 1 — devs extra para activar peer comparisons ─────
    {
        "id": "polanco-moderno", "slug": "polanco-moderno",
        "name": "Polanco Moderno", "colonia_id": "polanco",
        "street": "Horacio 820", "postal_code": "11560",
        "developer_id": "habitare-capital",
        "stage": "en_construccion", "delivery_estimate": "2027-02",
        "price_from": 11800000, "price_to": 24500000,
        "amenities": ["gym", "alberca", "concierge", "roof", "spa", "seguridad", "salon_eventos", "business_center"],
        "description": "Torre residencial contemporánea de 18 niveles sobre Horacio, a tres cuadras de Parque América. Diseño de Habitare con fachada de travertino, cocinas Bulthaup y domótica integral. Gym, alberca semi-olímpica y sky lounge con vista al Parque Lincoln.",
        "prototypes": [
            {"name": "A", "beds": 2, "baths": 2, "parking": 2, "m2_priv": 105, "m2_balcony": 10, "price_base": 12100000},
            {"name": "B", "beds": 3, "baths": 3, "parking": 2, "m2_priv": 152, "m2_balcony": 15, "price_base": 17500000},
            {"name": "PH", "beds": 3, "baths": 4, "parking": 3, "m2_priv": 220, "m2_balcony": 38, "m2_roof": 62, "price_base": 24500000},
        ],
        "levels": (2, 16),
        "progress": 42,
    },
    {
        "id": "roma-norte-orquidea", "slug": "roma-norte-orquidea",
        "name": "Orquídea Roma", "colonia_id": "roma-norte",
        "street": "Orizaba 215", "postal_code": "06700",
        "developer_id": "agora-urbana",
        "stage": "preventa", "delivery_estimate": "2027-09",
        "price_from": 4950000, "price_to": 11400000,
        "amenities": ["roof", "gym", "cowork", "pet", "seguridad", "bicicletas", "jardin"],
        "description": "Edificio boutique de 6 niveles con intervención arquitectónica respetuosa del patrimonio art decó de Orizaba. 24 unidades con cocinas abiertas, ventanales de piso a techo y roof-garden comunal con huerto urbano.",
        "prototypes": [
            {"name": "A", "beds": 1, "baths": 1, "parking": 1, "m2_priv": 58, "m2_balcony": 4, "price_base": 4950000},
            {"name": "B", "beds": 2, "baths": 2, "parking": 1, "m2_priv": 85, "m2_balcony": 8, "price_base": 7400000},
            {"name": "C", "beds": 3, "baths": 2, "parking": 2, "m2_priv": 118, "m2_balcony": 12, "price_base": 10200000},
            {"name": "PH", "beds": 3, "baths": 3, "parking": 2, "m2_priv": 135, "m2_balcony": 28, "m2_roof": 48, "price_base": 11400000},
        ],
        "levels": (1, 6),
        "progress": 15,
    },
    {
        "id": "condesa-terraza", "slug": "condesa-terraza",
        "name": "Terraza Condesa", "colonia_id": "condesa",
        "street": "Amsterdam 122", "postal_code": "06140",
        "developer_id": "sereno",
        "stage": "preventa", "delivery_estimate": "2027-06",
        "price_from": 6200000, "price_to": 13800000,
        "amenities": ["gym", "roof", "cowork", "pet", "seguridad", "salon_eventos", "jardin"],
        "description": "Proyecto boutique de 18 unidades sobre Amsterdam, frente a Parque México. Diseño biofílico de Sereno, materiales locales (madera tropical certificada, cantera), iluminación natural en 100% de las unidades. Roof con terraza verde, gimnasio y cowork con vista al Parque España.",
        "prototypes": [
            {"name": "A", "beds": 1, "baths": 1, "parking": 1, "m2_priv": 68, "m2_balcony": 6, "price_base": 6200000},
            {"name": "B", "beds": 2, "baths": 2, "parking": 1, "m2_priv": 96, "m2_balcony": 10, "price_base": 8900000},
            {"name": "C", "beds": 3, "baths": 2, "parking": 2, "m2_priv": 128, "m2_balcony": 14, "price_base": 11700000},
            {"name": "PH", "beds": 3, "baths": 3, "parking": 2, "m2_priv": 148, "m2_balcony": 32, "m2_roof": 55, "price_base": 13800000},
        ],
        "levels": (1, 7),
        "progress": 12,
    },
