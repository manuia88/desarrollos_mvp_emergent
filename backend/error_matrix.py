...
CELDAS: List[tuple] = [
    ...
    ("precio", "interpretar", "mezcla_tamanos_falso_outlier", "auditor._gemelas_ppm2 (cohorte de tamaño, no edificio)", "Casa Alpes 46k vs 80k/m² legítimo"),
    ("unidad", "interpretar", "local_mal_tipado_como_depto", "auditor._es_depto_auditor backstop de nombre + eliminación", "27 locales LC/L- inflando $/m² y desde"),
    ("general", "interpretar", "local_contado_como_depto", "auditor.r_general_coherente cuenta solo deptos", "Casa Condesa falso 74>73"),
