...
_PIEZAS: List[Dict[str, Any]] = [
    ...
    _p("inventario_drill", "inventario", "vista", "Inventario (todo en uno)",
       ...
       "Dejas de brincar entre pantallas: ver, revisar y modificar en un solo lugar.",
       "Entra, elige un dev, abre su proyecto y haz clic en cualquier unidad para editarla.",
       "/superadmin/inventario", temas=["inventario", "unidades", "disponibilidad", "editar", "torre"]),
    ...
    _p("sala_inversionistas", "dinero", "vista", "Sala de Inversionistas",
       "Tu perfil para YC y fondos: entrevistas, pilotos, números del negocio y checklist legal.",
       "Qué tan listo estás para levantar capital y qué falta (con fuente verificable por número).",
       "Llegas a una due diligence sin sorpresas y con evidencia, no con slides.",
       "Registra entrevistas y pilotos, edita supuestos del mercado y marca el checklist legal.",
       "/superadmin/inversionistas", temas=["yc", "vc", "inversion", "fundraising", "pitch"]),
    _p("demo_publico", "dinero", "vista", "Demo para externos",
       "Recorrido público de 5 pasos con datos simulados: cómo funciona la plataforma.",
       "El problema, el dato, el genoma, los motores y el ciclo completo — sin exponer nada real.",
       "Tienes qué mostrar en una llamada con YC, un VC o un desarrollador, sin dar tu sesión.",
       "Ábrelo en /demo o copia el link desde la Sala de Inversionistas.",
       "/demo", temas=["demo", "yc", "pitch", "recorrido"]),
...
_HUB_INCLUYE: Dict[str, List[str]] = {
    ...
    "alta_devs": ["Alta manual", "Carga masiva (IA)", "Directorio de desarrolladores",
                  "Vigía de Drive", "Prototipos", "Bandeja de aprobación"],
    "sala_inversionistas": ["Entrevistas de usuarios", "Pilotos y LOIs", "Números del negocio",
                            "Checklist legal", "Demo para externos"],
