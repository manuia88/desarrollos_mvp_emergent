...
const LOCAL_TEMPLATES = {
  ...
  mood_share: ({ vibe_label = '', top_matches_count = 0 } = {}) =>
    `Acabo de descubrir mi vibe en DesarrollosMX: "${vibe_label || 'mi vibe'}". Me arrojo ${top_matches_count || 5} propiedades match. ¡Pruebalo tu! https://desarrollosmx.io/portal/vibe`,
};
