        ...
        {data && (
          <>
            ...
            <div style={{ display: 'flex', gap: 6, marginBottom: 16, borderBottom: '1px solid rgba(255,255,255,0.07)', paddingBottom: 4, flexWrap: 'wrap' }}>
              {[['resumen', 'Resumen'], ['equipo', `Equipo (${data.members_total})`], ['auditoria', 'Auditoría'], ['phase-y', 'Phase Y'], ['sub-agents', 'Sub-Agents'], ['atlax-persona', 'Atlax Persona'], ['match-weights', 'Match Weights']].map(([k, l]) => (
