...
export const DEMO_BUSQ = {
  'demo-ana':   [{ id: 'b-ana',  colonias: ['Roma'],    precio_max: 4000000, recamaras_min: 2, banos_min: 2, estacionamientos_min: 1, m2_min: 90,  forma_pago: 'credito',                              plazo_compra: '3 meses' }],
  'demo-juan':  [{ id: 'b-juan', colonias: ['Condesa'], precio_max: 9000000, precio_min: 5000000, recamaras_min: 3, banos_min: 2, estacionamientos_min: 2, m2_min: 140, forma_pago: 'credito', credito_tipo: 'infonavit', plazo_compra: '6 meses' }],
