  ...
  return (
    <div data-testid="score-widget" style={shellStyle}>
      ...
      <div style={{
        ...
        marginBottom: 10, gap: 10, marginTop: 4,
      }}>
        <div>
          <div style={{
      ...
      {/* Mini stats inline · dark glass card sobre cream para contraste DMX */}
      <div style={{
    ...
    <div>
      ...
      {delta != null && (
        <div style={{
          ...
          color: delta > 0 ? '#22C55E' : delta < 0 ? '#EF4444' : (dark ? 'rgba(240,235,224,0.45)' : '#9CA3AF'),
          marginTop: 1,
        }}>
