...
function sectionFromPath(p) {
  ...
  if (/^\/superadmin\/(ai-cost|commercial|api-keys|vertical-products|data-licensing|cross-sell-analytics|soc-franchise|marketplace-templates)/.test(p)) return 'monetizacion';
