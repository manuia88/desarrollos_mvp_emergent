...
function sectionFromPath(p) {
  ...
  if (/^\/superadmin\/(scores|drpi|indices|risk-score|investment-explorer|intelligence-hub|trends|phase5-foundation|transactions|avm-accuracy|forecast-accuracy|knowledge-graph|live-pulse|grafo-comprador|construction-quality|reviews-residents|conversations|kb-gaps|ab-testing|conversation-drift)/.test(p)) return 'inteligencia';
