  ...
  return (
    <div data-testid="lp-timeline-tab" style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
      ...
      <div style={{
        ...
        border: '1px solid rgba(124,47,255,0.20)', borderRadius: 14, padding: 14,
      }}>
        ...
        <select
          ...
          style={{
            ...
            border: '1px solid rgba(124,47,255,0.30)', minWidth: 180,
          }}>
          ...
          {PERIODS.map((d) => (
            <button
              ...
              style={{
                ...
                background: days === d ? 'linear-gradient(90deg, rgba(124,47,255,0.30), rgba(192,38,211,0.25))' : 'rgba(255,255,255,0.04)',
                color: days === d ? '#e0e7ff' : 'rgba(240,235,224,0.65)',
                border: days === d ? '1px solid rgba(124,47,255,0.55)' : '1px solid rgba(255,255,255,0.10)',
        ...
        <button
          ...
          style={{
            ...
            border: '1px solid rgba(124,47,255,0.45)',
      ...
      <div style={{
        background: 'rgba(13,16,23,0.92)', backdropFilter: 'blur(24px)',
        border: '1px solid rgba(124,47,255,0.20)', borderRadius: 14, padding: 18, minHeight: 360,
      }}>
        {chartData.length === 0 ? (
            ...
            <AreaChart data={chartData} margin={{ top: 8, right: 16, left: -8, bottom: 0 }}>
              <defs>
                <linearGradient id="lpScore" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%"  stopColor="rgba(124,47,255,0.45)" />
                  <stop offset="100%" stopColor="rgba(124,47,255,0.02)" />
                </linearGradient>
              </defs>
              ...
              <Area type="monotone" dataKey="score" stroke="rgba(124,47,255,0.95)" strokeWidth={2.2} fill="url(#lpScore)" />
            </AreaChart>
          </ResponsiveContainer>
        )}
      </div>
...
function StatCard({ label, value }) {
  return (
    <div style={{
      background: 'rgba(13,16,23,0.92)', backdropFilter: 'blur(24px)',
      border: '1px solid rgba(124,47,255,0.20)', borderRadius: 14, padding: 16,
    }}>
      <div style={{ fontFamily: 'DM Mono', fontSize: 10, color: 'rgba(240,235,224,0.55)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>
        {label}
      </div>
      <div style={{ fontFamily: 'Outfit', fontWeight: 700, fontSize: 28, color: 'rgba(124,47,255,0.95)', marginTop: 4 }}>
