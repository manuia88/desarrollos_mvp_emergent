          ...
          {COLONIAS.map(c => (
            <button
              ...
              style={{
                ...
                background: selected.includes(c) ? 'rgba(99,102,241,0.12)' : 'transparent',
                border: 'none', cursor: 'pointer',
                fontFamily: 'DM Sans', fontSize: 13,
                color: selected.includes(c) ? '#818CF8' : 'rgba(240,235,224,0.70)',
            ...
            {(preview || simulating) && (
              <div data-testid="auto-approve-preview" style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 4 }}>
                  ...
                  <span style={{ fontFamily: 'DM Sans', fontSize: 11, fontWeight: 700, color: '#818CF8', textTransform: 'uppercase', letterSpacing: '0.07em' }}>
                ...
                {simulating ? (
                  ...
                  <span style={{ fontFamily: 'DM Sans', fontSize: 13, color: 'var(--cream)' }}>
                    Con esta regla, <strong style={{ color: '#818CF8' }}>{preview.pct}%</strong> de asesores activos
