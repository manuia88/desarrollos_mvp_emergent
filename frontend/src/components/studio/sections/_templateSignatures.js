...
export const TEMPLATE_SIGNATURES = {
  modern: {
    ...
    layout: { border_radius:16, section_padding:'80px 24px', card_style: 'glass', spacing_scale: 'balanced' },
    tone: 'clean',
  ...
  luxury: {
    ...
    layout: { border_radius:0, section_padding:'120px 24px', card_style: 'minimal-border', spacing_scale: 'spacious' },
    tone: 'exclusive',
  ...
  family: {
    ...
    layout: { border_radius:24, section_padding:'100px 32px', card_style: 'soft-shadow', spacing_scale: 'comfortable' },
    tone: 'warm',
  ...
  investor: {
    ...
    layout: { border_radius:8, section_padding:'64px 24px', card_style: 'data-card', spacing_scale: 'dense' },
    tone: 'data',
  ...
  boutique: {
    ...
    layout: { border_radius:4, section_padding:'96px 32px', card_style: 'textured-paper', spacing_scale: 'comfortable' },
    tone: 'artisan',
  ...
  urgent: {
    ...
    layout: { border_radius:12, section_padding:'60px 20px', card_style: 'alert-bordered', spacing_scale: 'tight' },
    tone: 'urgent',
  ...
  scrollytelling: {
    ...
    layout: { border_radius:12, section_padding:'140px 48px', card_style: 'transparent-overlay', spacing_scale: 'very-spacious' },
    tone: 'cinematic',
  ...
  video_first: {
    ...
    layout: { border_radius:8, section_padding:'72px 24px', card_style: 'dark-translucent', spacing_scale: 'balanced' },
    tone: 'cinematic',
  ...
  social_proof: {
    ...
    layout: { border_radius:16, section_padding:'80px 24px', card_style: 'testimonial-card', spacing_scale: 'balanced' },
    tone: 'trust',
  ...
  compare: {
    ...
    layout: { border_radius:12, section_padding:'72px 24px', card_style: 'comparison-table', spacing_scale: 'dense' },
    tone: 'compare',
