...
| **Wave 4 — Agentic + Investor Sim + Brand + Intelligence + Behavioral ML + Probability UX + Polish** (Phase Y reorientada ML + 5/6/8 ext/10/11/16 ext + Amenities Validator/19 ext/20 + CC + MCP Brand Strategy ext + Diagnostic Engine ✅ + Recommendation Banner ✅ + Comparable Anomaly ✅ + MCP server ✅ + GEO foundation ✅ + Watermarks/QR/MCP filters ✅ + Filter URL infrastructure ✅ + Behavioral Tracking + Real-time Demand + State of CDMX Report + Free audit + Probability UX A + Smart Notifications B + Embeddable Widgets C) | 🟡 EN CURSO 53.5/461h (W4.1+W4.2A-D1 shipped) | ~461h |

**Total H1 restante**: ~407.5h (Wave 1+2+3 cerradas · Wave 4 = 461h - 53.5h shipped = 407.5h pending)

**Shipped to date**: ~777.5h (Phase 4-refactor + Phase 1-3 + B2B + Wave 1 50h + Wave 2 120h + Wave 3 197h + Wave 4 53.5h)
