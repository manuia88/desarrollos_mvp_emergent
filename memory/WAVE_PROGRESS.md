...
**Última actualización**: 2026-05-10 (W4.18.3 Private Beta Gate ✅ shipped SHA `d1e81b8` · 🎯 **Bloque W4.18 CERRADO 63/63h** (Data Sources 22h ✅ + Apify 5h ✅ + PostHog 1h ✅ + Mapa core 16h ✅ + Mapa cross 16h ✅ + Private Beta 8h ✅ - Apify 2h dups = neto 63h shipped) · W5.20-21 DMX Insights Layer 41h Wave 5 H2 aprobado · Wave 4 ~356.5h/495h · 138.5h H1 pending · Wave 5 H2 sketch 337h con DMX Insights Layer)
...
| W4.13.A | Phase 16 ext **Lead Journey Outbound** asesor→dev (timeline + 14 step types + outbound asesor portal + bulk re-route + audit + cross-cutting hooks: smart_routing W4.6 · nurture Y.3E · whatsapp W4.10 · DISC W4.4 · atlax · captura form · meeting Calendar · close won/lost) | 12 | — | emergent | ⏳ | — | siguiente prompt · Meta Ads automation y cross-org diferidos Wave 5 |
| W4.13.B | Phase 16 ext **Project Performance Intelligence** (dev sube proyecto pre-construction → DMX corre A/B Meta Ads campañas auto + recomendaciones cuantificadas: % apreciación + ROI + reducción ciclo venta · ML predict velocity vs benchmarks) | 20 | — | emergent | ⏳ | — | después W4.13.A · requiere FB Ads API token founder · si no disponible H1 → diferir Wave 5 W5.10 |
