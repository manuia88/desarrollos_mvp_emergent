...
**Qué hace**: cron mensual descarga DENUE CSV (INEGI) + SESNSP CSV · ingesta a `db.denue_pois` + `db.crime_records` · cron subscores W5.3 P2A (ya 02:30 UTC) recalcula con datos reales sin tocar código.

**Costo**: ~6-8h.

**Activar cuando**: portal en producción público con tráfico real Y/O preparación de prensa outreach donde cifras necesiten ser defendibles.
