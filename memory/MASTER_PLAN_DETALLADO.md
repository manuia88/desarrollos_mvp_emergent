...
| EX.2 | Scores REALES por colonia: **puente `score_bridge` + cómputo por catálogo + cobertura** ✅. **6 de 7 dimensiones reales** ✅: vida·comercio·movilidad·educación (OSM) + seguridad·riesgo (FGJ). Transporte y educación se derivan del MISMO OSM (estaciones/paradas + escuelas, sin API nueva). **Falta solo precio/plusvalía** (necesita DRPI/mercado · va con Tanda C). | 🟡 6/7 dims (2026-06-08) |
