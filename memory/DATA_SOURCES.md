...
| **Valores unitarios 2026** ✅ stub | Tablas oficiales $/m² suelo + construcción por zona (Gaceta CDMX) | **Conector LISTO** (`valores_unitarios_engine` · status + ingest + botón superadmin) · honesto no-op hasta cargar la tabla · al cargar, prefiere este valor sobre el SIG 2022 | `IE_VALORES_UNITARIOS_2026_URL` | ancla de suelo MÁS reciente (refuerzo de ING.2; opcional porque el modelo ya aprende de ventas) |
