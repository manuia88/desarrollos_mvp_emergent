...
| **W5.20-21** | External Insights Ingest (RE-SCOPED 2026-05-18) | ⬜ | 28-33h (NO 41h · audit detectó 80% del scope original ya shipped en ZonePage/ColoniaLanding/StateOfCDMX/intelligence_insights_engine) · **Plan A re-scope founder approved**: intent real spec INSIGHTS_SOURCES_RESEARCH.md = ingestar 14 fuentes globales (JLL · Knight Frank · CBRE · BIS · OECD · INEGI · SHF · CONAVI · AMPI · AMDI · BMV · Fitch · Zillow · Numbeo · BANXICO ya integrado W4.18) · ser referente prensa MX · cross-comparativas MX vs Mundo · partido 2 batches W5.20 backend 15h + W5.21 UI/SEO 13-18h |
