...
| **W5.9** | Climate Migration | 📦 DIFERIDO final W5 | Founder decision 2026-05-17 · revisar fuentes gov MX maduras (CENAPRED · SIMAT · SACMEX) + decisión upgrade Apify $49 + opción auto-source watchdog reusable +8h · ~25h-33h scope final TBD |
...
| **W5.16** | Social Cards Multi-platform Renderer | ✅ | merge `e42bf945` · 11h shipped 2026-05-18 · Claude Code ULTRA-defensivo · 3 layouts (og 1200×630 / feed 1080×1080 / story 1080×1920) · Pillow + Mapbox Static · cache LRU 24h + disk · 4 entity_types · meta og:image en 3 pages públicas · dashboard superadmin CRECIMIENTO teal · post-tag `shipped-W5.16-social-cards-20260518-2244` |
| **W5.25** | Widget Embed Analytics | ✅ | merge `6cbb2b24` · 6h shipped 2026-05-18 · Claude Code ULTRA-defensivo · 7 widgets W4.2.5 con tracking activo (3 con slug + 4 vertical hash sha256 sin exposición credentials) · 3 endpoints · daily digest cron 09:00 UTC · dashboard superadmin OPERACIÓN naranja · derive_widget_slug helper extensible · post-tag `shipped-W5.25-widget-embed-analytics-20260518-2225` |
...
| **W5.20** | External Insights Ingest backend | ✅ | merge `a49ea651` · 25h shipped 2026-05-19 · Claude Code ULTRA-defensivo · 12 fuentes globales connectors gratis (BIS · OECD · IMF · World Bank · FRED · INEGI · BMV · HR Ratings · Numbeo · GPG · Zillow CSV · Realtor) · cron weekly + macro alert daily · Atlax tool #23 · 5 endpoints · extend intelligence_insights_engine cross_source_brief · post-tag `shipped-W5.20-external-insights-20260518-2312` |
| **W5.22 Z.8.6** | Section Variants + Dark/Light · 4 fixes: importer inline + modal scroll + _templateSignatures shared (10 templates signature visual cross-section consistente) + dark/light spirit-aware toggle | ✅ | 4 commits `4596833c`+`6b961293`+`8964133a`+`e000d6f9` · 21h shipped 2026-05-20 · Claude Code · 22 archivos · +534/-62 · audit forense PASS · post-tag `post-W5.22-Z.8.6-section-variants-darklight-260520-0224` |
| **W5.22 Z.8.5.1** | Corrective FIX · conectar frontend Z.8.5 al backend (audit forense detectó frontend NO consumía templates spec) | ✅ | 5 commits `7414016e`+`ff381bdd`+`eee3e707`+`38ab337e`+`9407f2bd` · 6h shipped 2026-05-20 · Claude Code · 7 archivos · +244/-13 · radio dev/reventa + SectionRenderer dispatch 10 sections custom + sections_order render + endpoint /templates/:key + auto-inject unique_section_type · smoke 10/10 templates · post-tag `post-W5.22-Z.8.5.1-corrective-260520-0138` |
| **W5.22 Z.8.5 v2** | Property Templates Únicos + 7 upgrades cierre ciclo · 10 templates genuinamente distintos + Atlax tools #24+#25 + property_source dev/reventa + routing hybrid + social cards auto + brochure PDF + cross-links + analytics + A/B lead quality | ✅ | 10 commits secuenciales (5fcfd8c7→2010d590) · 40h shipped 2026-05-20 · Claude Code ULTRA-defensivo · 22 archivos · +2970/-27 · 7 archivos backend NEW · Atlax 23→25 tools · post-tag `post-W5.22-Z.8.5-property-templates-uniques-260520-0117` |
| **W5.22 Z.8.4** | Marketplace Empoderado · catálogo completo asesor + filtros funcionales + map + pagination + builder visual | ✅ | 5 commits `78b1538a`+`10a94898`+`c5371113`+`ecb894ff`+`2c50b570` · 5h shipped 2026-05-20 · Claude Code ULTRA-defensivo · 10 archivos · +958/-45 · post-tag `post-W5.22-Z.8.4-marketplace-empoderado-260520-0039` |
| **W5.22 Z.8.3** | Landing Themes Engine · 10 themes únicos visualmente diferenciados (paleta + typography + layout + animation + section variants) | ✅ | 3 commits `49fb9724`+`99eeda68`+`493c9d68` · 12h shipped 2026-05-20 · Claude Code ULTRA-defensivo · 21 archivos · +1637/-246 · cada template renderiza distintivamente · template selector enhanced + live switch · post-tag `post-W5.22-Z.8.3-themes-260520-0017` |
| **W5.22 Z.8.2** | Landing Builder profesional rework (split-pane editor · 14 sections · 3 use cases hydrated · pixel injection · 3 starters) | ✅ | merge `9ace79bd` cherry-pick selectivo · 43h shipped 2026-05-19 · 23 archivos · +1911/-329 · post-tag `post-W5.22-Z.8.2-builder-pro-260519-2349` |
| **W5.22 Z.8** | Studio Landing Pages Profesionales 10 templates (Plan Full · v1 deprecated) | 🔄 | merge `601a17d8` cherry-pick selectivo · 43h shipped 2026-05-19 · DEPRECATED · 10 templates v1 borrados commit `d1cc0285` · reemplazado por Z.8.2 · 27 archivos · 3191L · 10 templates premium + builder + A/B + PDF + Atlax embed · 3 features registradas · 5 conflicts resueltos UNIÓN preservando Z.2 · post-tag `post-W5.22-Z.8-landing-pages-260519-1925` |
| **W5.22 Z.2** | Studio Buyer-angle Copy + Carrusel + Auto-content + 5 upgrades (Plan Full) | ✅ | backend merge `dbdfebf5` cherry-pick + frontend merge `e1553731` Claude Code · 28h shipped 2026-05-19 · 9 archivos backend 1877L + 8 archivos frontend 1266L · 3 features (buyer_copy pro $99 · carrusel_auto pro $149 · auto_content enterprise $299) · 13 endpoints · A/B testing chi² + real-time preview + PDF export + Hook score gate + multi-language ES/EN · violaciones emergent PRD/ROADMAP descartadas · 7/7 críticos diff=0 · post-tag `post-W5.22-Z.2-frontend-260519-1657` |
| **W5.22 Z.1.1** | CERO DEUDA Studio Z.1 (5 sub-fixes + R2 public URL fix) | ✅ | merge `51912c6d` + `3e28b34f` · 2.5h shipped 2026-05-19 · Claude Code · 5 fixes: i18n 86 strings + eager loader + tokenize hex + docs R2 354L + rate-limit MongoDB + manual R2_PUBLIC_URL helper · Cloudflare activado founder · Studio funcional end-to-end · post-tag `post-W5.22-Z.1.1-cero-deuda-260519-1443` |
| **W5.22 Z.1** | Studio Brand Kit + Listing Importer + Asset Library | ✅ | merge `36879dc2` cherry-pick · 16h shipped 2026-05-19 · emergent origen 3 commits Sub-A/B/C · 16 archivos · +2924/-0 · 3 features Studio registradas · BLOCKED Inmuebles24/Lamudi/Vivanuncios · R2 stub mode FAIL-SOFT · audit 10/10 PASSED críticos diff=0 · post-tag `post-W5.22-Z.1-brand-kit-260519-1212` |
| **W5.FF6** | Migration feature_registry CIERRE 100% (cero deuda técnica) | ✅ | merge `d621cf20` · 2h shipped 2026-05-19 · Claude Code ULTRA-defensivo 8/8 · 6 features añadidas (zone_score · probability_ux · social_cards · widget_embeds_analytics · external_insights · forecast_root) · api_keys_mgmt OMITIDO doc · 10/10 críticos diff=0 · resuelve hallazgo audit forense 2026-05-19 · post-tag `post-W5.FF6-migration-complete-260519-1109` |
| **W5.21** | External Insights UI/SEO pages comparativas | ✅ | merge `821d891a` · 14h shipped 2026-05-19 · Claude Code ULTRA-defensivo 7/7 · 3 sub-chunks Sub-A/B/C `62982b04`+`26e5e559`+`821d891a` · 9 archivos · 1185 insertions · `InsightsGlobal.js` 456L + `InsightsCompare.js` 518L (8 topics SEO long-tail) + MethodologyPage section 9 (12 fuentes) + PrensaPage Atlax tool #23 visible + sitemap +9 URLs · upgrade og:image dinámico via W5.16 social_cards (`insights` entity_type) · 17/17 críticos diff=0 · post-tag `post-W5.21-external-insights-ui-260519-0953` |
